...
A setter method 'setInitialSaving' that will take an integer as a parameter and set the value of savings equal to that of the integer .
...
A method to check the savings of a person say 'checkSaving'. If the savings amount is greater than or equal to Rs.1000, print “Congratulations! You have saved a good amount”. If the amount is less than Rs.1000 and greater than or equal to 0, print “Insufficient saving!”. If the savings amount is less than 0, print “You are in debt”.
...
Call the 'decrementSaving' method once.
Call the incrementSaving' method once.
Call the 'checkSaving' method.
