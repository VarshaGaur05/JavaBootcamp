...
import java.io.InputStreamReader;
    ...
    /*Line length
Description
Find the sum of the length of the lines. A line is defined with two points A and B on the number line.
For example, if A = -3 and B = 10, the length of the line is 13. This is because the distance between
 -3 and 10 on the number line is 13 units (10 -(-3) = 13).
Similarly, if A = 9 and B = 5, the length of the line will be 4 units, as the distance between
9 and 5 on the number line is 4 units (9 - 5 = 4). You need to complete the method getTotalSumOfLines.
